...
class Graph(object):
    ...
    def k_shortest_paths(self, start, finish, k=3):
        ...
        while num_shortest_path < k:
            ...
            if len(distancesIncrementList) == 0:
            #     continue
                print("start is {}, end is {}".format(start, finish))
            ...
            for neighbor in self.graph[min_vertex]:
                ...
                if distances[min_vertex] == (distances[neighbor] + self.graph[min_vertex][neighbor]):
                    ...
                    increment = minValue + distances[neighbor] + self.graph[min_vertex][neighbor] - distances[
                        min_vertex]
